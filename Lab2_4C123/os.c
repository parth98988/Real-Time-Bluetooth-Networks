...
#define NUMTHREADS	4 // maximum number of main threads
...
int32_t periodPt1;
int32_t periodPt2;
void (*Periodic_Tsk1Pt)(void);
void (*Periodic_Tsk2Pt)(void);
...
int32_t status;
	...
	Periodic_Tsk1Pt = thread1;
	periodPt1 = period1;
	Periodic_Tsk2Pt = thread2;
	periodPt2 = period2;	
  return 1;
...
void Scheduler(void){ // every time slice
  ...
  //***YOU IMPLEMENT THIS FUNCTION*****
	int32_t LCM = periodPt1*periodPt2;
	count = (count +1)%LCM;
	if(count % periodPt1 == 0)
	{
	(*Periodic_Tsk1Pt)();
	}
	if(count % periodPt2 == 1)
	{
		(*Periodic_Tsk2Pt)();
	}
